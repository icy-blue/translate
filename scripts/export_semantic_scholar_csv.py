...
from backend.persistence.models import Conversation, PaperSemanticScholarResult
            ...
            writer.writerow(
                {
                    ...
                    "venue_abbr": normalize_value(result.venue_abbr),
                    "ccf_category": normalize_value(result.ccf_category),
                    "ccf_type": normalize_value(result.ccf_type),

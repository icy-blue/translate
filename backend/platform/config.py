...
class Settings(BaseSettings):
    ...
    continue_prompt: str = Field(
        default=(
            ...
            "- Exclude standalone figure captions, standalone table captions, figure legends, and table contents unless they are clearly part of the current unit’s running text.\n"

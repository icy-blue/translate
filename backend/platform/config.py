...
class Settings(BaseSettings):
    ...
    initial_prompt: str = Field(
        default=(
            ...
            "- Exclude title, authors, affiliations, emails, keywords, acknowledgements, references, bibliography, supplementary material, standalone figure/table captions, figure legends, and table contents.\n"
    ...
    continue_prompt: str = Field(
        default=(
            ...
            "- If no running prose remains after skipping those artifacts, return `state` as `OK` and output only the translated visible heading followed by `（本章仅图表）` on the next line.\n"

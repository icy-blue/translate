...
class Settings(BaseSettings):
    ...
    initial_prompt: str = Field(
        default=(
            ...
            "first_round_rules:\n"
            "1. 首轮优先从摘要正文开始翻译；如果无法可靠识别摘要，则从正文第一段可翻译内容开始。\n"
            "2. Abstract 必须输出为一级标题“# 摘要”。\n"
            "3. 正文中的章节标题和小节标题仍需正常输出，但标题文本保持原文，不翻译成中文。\n"
            "4. 不得先输出标题页信息；禁止输出论文主标题、作者、机构、邮箱、独立 figure caption、独立 table caption。\n"
            "5. “已完成”默认指摘要与正文已完成，不包括附录、致谢、参考文献。\n\n"

...
class PoeGatewayTest(unittest.TestCase):
    ...
    def test_deepseek_arxiv_pdf_uses_html_text_without_pdf_extraction(self):
        ...
        complete_html_text = "Precise arXiv HTML text. " + ("Body text. " * 1400) + "References\n[1] Test."

        with (
            patch.object(poe, "_arxiv_html_text", return_value=complete_html_text) as html_mock,
    ...
    def test_deepseek_arxiv_pdf_falls_back_when_html_is_incomplete(self):
        captured_payloads: list[dict] = []
        ...
        with (
            patch.object(poe, "_arxiv_html_text", return_value="1 Introduction\n\n2 Related Work\n\nGenerated by LaTeXML"),
